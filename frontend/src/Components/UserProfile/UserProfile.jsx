...
function UserProfile() {
    ...
    const [interestedTechStack, setinterestedTecStack] = useState(user.interestedTechStack);
    ...
    }, [techStackInput, techStack, interestedTechStackInput, interestedTechStack, image, isSJSUStudent]);
